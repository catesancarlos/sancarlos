    ...
    return (
        <div>
            ...
            <p className='pf2'>
                ...
                cual participaran nuestros alumnos.
            </p>
            <strong>Objetivos</strong>
            <p className='pf2'>
                • Fomentar el ambiente y ánimo deportivo en cada uno de los alumnos y de los catequistas.<br/>
                • Fortalecer los lazos de amistad y respeto entre todos los jugadores, animando el mejor desarrollo físico reflejando en el deporte.<br/>
            ...
            <p className='pf2 sb'>
                El campeonato para este año va dirigido para los alumnos de todos los niveles (desde 
            ...
            <p className='pf2'>
                El campeonato también está dirigido para catequistas y en esta ocasión se enfrentarán los
            ...
            <p className='pf2'>
                La duración de un partido dependiendo del nivel de cada paralelo es el siguiente:<br/>
                • <strong>Niveles de Confirmacion:</strong> Cada partido es de 40 minutos, dividido en 2 
                tiempos de 20 minutos.<br/>
                • <strong>Niveles de Comunión:</strong> Por definir.
            </p>
            <strong>Disciplina</strong>
            <p className='pf2 sb'>
                El Campeonato es de futbol sala, por lo que se tomara como referencia las reglas de esta 
                disciplina.
            </p>
